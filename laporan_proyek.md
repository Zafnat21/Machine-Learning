...
Pendekatan ini sejalan dengan penelitian tentang rekomendasi game Steam yang memanfaatkan collaborative filtering, SVD, dan data jam bermain sebagai dasar preferensi pengguna.
...
```text
rating = (hours / mean_hours) x 5
```

Nilai rating kemudian dibatasi maksimal 5 agar berada pada skala yang konsisten.
...
K-NN digunakan sebagai model pembanding. Model ini menggunakan cosine similarity dan pendekatan user-based collaborative filtering.
...
SVD digunakan sebagai model utama. Model ini bekerja dengan mempelajari pola laten antara pengguna dan game pada data rating simulasi.
...
Evaluasi dilakukan menggunakan RMSE dan MAE.

RMSE mengukur rata-rata kesalahan prediksi dengan memberi penalti lebih besar pada error yang tinggi. MAE mengukur rata-rata selisih absolut antara rating aktual dan rating prediksi.
...
1. William Evan Lomanto, Verry Andrian, Said Achmad, dan Rhio Sutoyo. Collaborative Filtering for Steam Games Recommendation.
2. Kendrick Raphael Ticoalua dan Ida Ayu Gde Suwiprabayanti Putra. Rekomendasi Video Game Menggunakan Metode Collaborative Filtering dengan K-NN.
3. Steam Video Games Dataset.
